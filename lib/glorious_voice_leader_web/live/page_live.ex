defmodule GVLWeb.PageLive do
  ...
  def render(assigns) do
    ...
    <p>Glorious Voice Leader is heavily inspired by <a href="https://amzn.to/2Ince4p">the works of the guitarist and educator, Ted Greene</a>. All hail, Glorious Voice Leader!</p>
